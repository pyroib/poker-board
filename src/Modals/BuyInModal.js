...
export default function BuyInModal({
  ...
  const [BuyInCost, setBuyInCost] = useState(buyInCost);
  const [BuyInChips, setBuyInChips] = useState(buyInChips);
  ...
  const save = () => {
    saveBuyIn(BuyInCost, BuyInChips);
    onClose();
  };
                      ...
                      <div className="w-full max-w-xs">
                        <form className="px-8 pt-6 pb-8 mb-4">
                          ...
                          <input
                            ...
                            value={BuyInCost}
                            placeholder="0"
                            onChange={(e) => setBuyInCost(e.target.value)}
                          />
                          <label
