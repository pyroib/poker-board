...
import {
  MODAL_FREEZEOUT_TITLE,
  MODAL_FREEZEOUT_TIME,
} from "../Constants/Strings.js";

export default function FreezeOutModal({
  isFreezeOutModalOpen,
  freezeOutTime,
  closeFreezeOutModal,
  saveFreezeOut,
}) {
  const [FreezeOutTime, setFreezeOutTime] = useState(freezeOutTime);
                      ...
                      <div className="w-full max-w-xs">
                        <form className="px-8 pt-6 pb-8 mb-4">
                          ...
                          <input
                            ...
                            value={FreezeOutTime}
                            placeholder="0"
                            onChange={(e) => setFreezeOutTime(e.target.value)}
                          />
                        </form>
                      </div>
                    </div>
